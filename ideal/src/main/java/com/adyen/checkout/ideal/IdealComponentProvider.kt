...
class IdealComponentProvider(
...
) : SessionPaymentComponentProvider<IdealComponent, IdealConfiguration, PaymentComponentState<IdealPaymentMethod>> {
    ...
    override fun get(
        ...
        defaultArgs: Bundle?,
        componentCallback: ComponentCallback<PaymentComponentState<IdealPaymentMethod>>,
        order: Order?,
        key: String?
    ): IdealComponent {
    ...
    override fun get(
        ...
        application: Application,
        defaultArgs: Bundle?,
        componentCallback: SessionComponentCallback<PaymentComponentState<IdealPaymentMethod>>,
        key: String?
    ): IdealComponent {
        assertSupported(paymentMethod)
