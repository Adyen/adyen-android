...
/**
 * Configuration class for the [MealVoucherComponent].
 */
@Parcelize
@Suppress("LongParameterList")
class MealVoucherConfiguration private constructor(
    ...
    /**
     * Builder to create a [MealVoucherConfiguration].
     */
    class Builder :
        ActionHandlingPaymentMethodConfigurationBuilder<MealVoucherConfiguration, Builder>,
        ...
        override fun buildInternal(): MealVoucherConfiguration {
            return MealVoucherConfiguration(
...
fun CheckoutConfiguration.mealVoucher(
    configuration: @CheckoutConfigurationMarker MealVoucherConfiguration.Builder.() -> Unit = {}
): CheckoutConfiguration {
    val config = MealVoucherConfiguration.Builder(environment, clientKey)
        .apply {
    ...
    MealVoucherComponent.PAYMENT_METHOD_TYPES.forEach { key ->
...
internal fun CheckoutConfiguration.getMealVoucherConfiguration(): MealVoucherConfiguration? {
    return MealVoucherComponent.PAYMENT_METHOD_TYPES.firstNotNullOfOrNull { key ->
        getConfiguration(key)
    }
}

internal fun MealVoucherConfiguration.toCheckoutConfiguration(): CheckoutConfiguration {
