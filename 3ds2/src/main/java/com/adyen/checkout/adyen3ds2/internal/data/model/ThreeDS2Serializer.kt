...
internal class ThreeDS2Serializer {
    ...
    fun createFingerprintDetails(encodedFingerprint: String): JSONObject {
        ...
        try {
            ...
            throw RuntimeException("Failed to create fingerprint details", e)
        }
    ...
    fun createChallengeDetails(transactionStatus: String, errorDetails: String? = null): JSONObject {
        ...
        try {
            ...
            throw RuntimeException("Failed to create challenge details", e)
        }
    ...
    fun createThreeDsResultDetails(
        ...
        try {
            ...
            throw RuntimeException("Failed to create ThreeDS Result details", e)
        }
