...
internal class ComponentFieldDelegateStateTest {

    private lateinit var initialState: ComponentFieldDelegateState<String>

    @BeforeEach
    fun setup() {
        initialState = ComponentFieldDelegateState(
            value = "initial",
    ...
    fun `when toComponentFieldViewState is called with valid validation, then errorMessageId should be null`() {
        val viewState = initialState.toComponentFieldViewState()
    ...
    fun `when toComponentFieldViewState is called with invalid validation and shouldHighlightValidationError is true, then errorMessageId should be set`() {
        ...
        val viewState = updatedState.toComponentFieldViewState()
