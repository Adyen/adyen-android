...
interface StoredPaymentComponentProviderOld<ComponentT : PaymentComponentOld<*>, ConfigurationT : Configuration> :
    PaymentComponentProviderOld<ComponentT, ConfigurationT> {
