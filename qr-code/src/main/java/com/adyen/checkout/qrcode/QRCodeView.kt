...
class QRCodeView :
    ...
    private fun copyCode() {
        ...
        context.copyTextToClipboard("Pix Code", code, localizedContext.getString(R.string.checkout_qr_code_copied_toast))
    }
    ...
    private fun onTimerTick(timerData: TimerData) {
        ...
        val minutesSecondsString = localizedContext.getString(R.string.checkout_qr_code_time_left_format, minutes, seconds)
        binding.textViewTimer.text = localizedContext.getString(R.string.checkout_qr_code_timer_text, minutesSecondsString)
