...
public class DotpayConfiguration extends IssuerListConfiguration {
     ...
     */
    public DotpayConfiguration(@NonNull Locale shopperLocale, @NonNull DisplayMetrics displayMetrics, @NonNull Environment environment) {
    ...
    public static final class Builder extends IssuerListBuilder<DotpayConfiguration> {
        ...
        public DotpayConfiguration build() {
            return new DotpayConfiguration(mBuilderShopperLocale, mBuilderDisplayMetrics, mBuilderEnvironment);
        }
    }
}
