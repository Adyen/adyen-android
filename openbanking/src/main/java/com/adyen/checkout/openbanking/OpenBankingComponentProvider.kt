...
class OpenBankingComponentProvider(
    ...
    override fun get(
        ...
        defaultArgs: Bundle?,
        componentCallback: ComponentCallback<PaymentComponentState<OpenBankingPaymentMethod>>,
        order: Order?,
        key: String?
    ): OpenBankingComponent {
    ...
    override fun get(
        ...
        application: Application,
        defaultArgs: Bundle?,
        componentCallback: SessionComponentCallback<PaymentComponentState<OpenBankingPaymentMethod>>,
        key: String?
    ): OpenBankingComponent {
        assertSupported(paymentMethod)
