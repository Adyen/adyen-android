...
class SddCheckoutMethod extends CheckoutMethod {
    SddCheckoutMethod(@NonNull Application application, @NonNull PaymentMethod paymentMethod) {
    ...
    public void onSelected(@NonNull CheckoutHandler checkoutHandler) {
        ...
        PaymentMethodHandler paymentMethodHandler = new SepaDirectDebitHandler(paymentReference, getPaymentMethod());
