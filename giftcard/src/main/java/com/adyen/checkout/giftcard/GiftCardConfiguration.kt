...
class GiftCardConfiguration : Configuration, BuildableConfiguration<GiftCardConfiguration> {
    ...
    override fun toBuilder(): BaseConfigurationBuilder<GiftCardConfiguration> = Builder(this)
