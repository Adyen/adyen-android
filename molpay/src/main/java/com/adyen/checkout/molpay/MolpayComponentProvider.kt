...
class MolpayComponentProvider(
...
) : SessionPaymentComponentProvider<MolpayComponent, MolpayConfiguration, PaymentComponentState<MolpayPaymentMethod>> {
    ...
    override fun get(
        ...
        defaultArgs: Bundle?,
        componentCallback: ComponentCallback<PaymentComponentState<MolpayPaymentMethod>>,
        order: Order?,
        key: String?
    ): MolpayComponent {
    ...
    override fun get(
        ...
        application: Application,
        defaultArgs: Bundle?,
        componentCallback: SessionComponentCallback<PaymentComponentState<MolpayPaymentMethod>>,
        key: String?
    ): MolpayComponent {
        assertSupported(paymentMethod)
