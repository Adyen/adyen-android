...
internal class InstantPaymentComponentTest(
    @param:Mock private val instantPaymentDelegate: InstantPaymentDelegate,
    ...
    @param:Mock private val componentEventHandler: ComponentEventHandler<InstantComponentState>,
) {
