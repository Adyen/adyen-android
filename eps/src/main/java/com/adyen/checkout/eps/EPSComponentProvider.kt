...
class EPSComponentProvider(
...
) : SessionPaymentComponentProvider<EPSComponent, EPSConfiguration, PaymentComponentState<EPSPaymentMethod>> {
    ...
    override fun get(
        ...
        defaultArgs: Bundle?,
        componentCallback: ComponentCallback<PaymentComponentState<EPSPaymentMethod>>,
        order: Order?,
        key: String?
    ): EPSComponent {
    ...
    override fun get(
        ...
        application: Application,
        defaultArgs: Bundle?,
        componentCallback: SessionComponentCallback<PaymentComponentState<EPSPaymentMethod>>,
        key: String?
    ): EPSComponent {
        assertSupported(paymentMethod)
