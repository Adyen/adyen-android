...
class ConvenienceStoresJPComponentProvider(
...
) : PaymentComponentProvider<ConvenienceStoresJPComponent, ConvenienceStoresJPConfiguration> {
    ...
    override fun get(
        ...
        return ViewModelProvider(viewModelStoreOwner, genericFactory)[key, ConvenienceStoresJPComponent::class.java]
    }
    ...
    override fun isPaymentMethodSupported(paymentMethod: PaymentMethod): Boolean {
        return ConvenienceStoresJPComponent.PAYMENT_METHOD_TYPES.contains(paymentMethod.type)
    }
}
