...
internal class DefaultCardDelegateTest(
    ...
    inner class InputDataChangedTest {
        ...
        fun `detect card type repository returns dual branded cards, then output data should be good`() = runTest {
            ...
            delegate.outputDataFlow.test {
                ...
                val selectedCard =
                    requireNotNull(
                        DetectedCardTypesUtils.getSelectedOrFirstDetectedCardType(
    ...
    private fun createOutputData(
        ...
        dualBrandedCardBrands: List<CardBrandItem> = emptyList(),
    ): CardOutputData {
        return CardOutputData(
            ...
            dualBrandCardBrands = dualBrandedCardBrands,
        )
    }
