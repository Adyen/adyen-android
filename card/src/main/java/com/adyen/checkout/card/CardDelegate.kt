...
abstract class CardDelegate(
    ...
    abstract fun validateAddress(addressInputModel: AddressInputModel, addressFormUIState: AddressFormUIState, detectedCardType: DetectedCardType? = null): AddressOutputData
