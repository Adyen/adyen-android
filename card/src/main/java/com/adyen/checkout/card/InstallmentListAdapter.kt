...
class InstallmentListAdapter(private val context: Context, private val localizedContext: Context) : BaseAdapter(), Filterable {
...
class InstallmentViewHolder(private val rootView: View, private val localizedContext: Context) : RecyclerView.ViewHolder(rootView) {
