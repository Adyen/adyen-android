...
class MBWayDelegate(val paymentMethod: PaymentMethod) :
    ...
    val outputDataFlow: Flow<MBWayOutputData?> = _outputDataFlow

    private val _componentStateFlow = MutableStateFlow<PaymentComponentState<MBWayPaymentMethod>?>(null)
    val componentStateFlow: Flow<PaymentComponentState<MBWayPaymentMethod>?> = _componentStateFlow
