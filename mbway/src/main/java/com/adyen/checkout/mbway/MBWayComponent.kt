...
class MBWayComponent internal constructor(
    ...
    PaymentComponentOld<PaymentComponentState<MBWayPaymentMethod>>,
    ViewableComponent,
    ButtonComponent,
    ...
    companion object {
        ...
        @JvmField
        val PROVIDER: PaymentComponentProviderOld<MBWayComponent, MBWayConfiguration> = MBWayComponentProvider()
