...
internal class CashAppPayComponentTest(
    @param:Mock private val cashAppPayDelegate: CashAppPayDelegate,
    ...
    @param:Mock private val componentEventHandler: ComponentEventHandler<CashAppPayComponentState>,
) {
