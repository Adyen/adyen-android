...
internal class IssuerListComponentTest(
    @param:Mock private val issuerListDelegate: IssuerListDelegate<TestIssuerPaymentMethod, TestIssuerComponentState>,
    ...
    @param:Mock private val componentEventHandler: ComponentEventHandler<TestIssuerComponentState>,
) {
