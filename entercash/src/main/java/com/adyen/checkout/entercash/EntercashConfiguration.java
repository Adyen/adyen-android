...
public class EntercashConfiguration extends IssuerListConfiguration implements BuildableConfiguration<EntercashConfiguration> {
    ...
    @NonNull
    @Override
    public BaseConfigurationBuilder<EntercashConfiguration> toBuilder() {
