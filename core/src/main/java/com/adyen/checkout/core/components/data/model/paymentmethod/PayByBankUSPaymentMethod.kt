...
/**
 * Payment method model for PayByBank US.
 */
@Parcelize
data class PayByBankUSPaymentMethod(
    ...
    companion object {
        @JvmField
        val SERIALIZER: Serializer<PayByBankUSPaymentMethod> =
            object : Serializer<PayByBankUSPaymentMethod> {
