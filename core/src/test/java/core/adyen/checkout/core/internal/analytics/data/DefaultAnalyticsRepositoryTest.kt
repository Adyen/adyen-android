package core.adyen.checkout.core.internal.analytics.data
...
internal class DefaultAnalyticsRepositoryTest(
    ...
    inner class SendEventsTest {
        ...
        @ParameterizedTest
        @MethodSource(
            "core.adyen.checkout.core.internal.analytics.data.DefaultAnalyticsRepositoryTest#sendEventsSource",
        )
