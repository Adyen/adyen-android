...
import com.adyen.checkout.authentication.internal.data.model.SubmitFingerprintRequest
...
internal class SubmitFingerprintRepository(
    ...
    suspend fun submitFingerprint(
        ...
        when (response.type) {
            RESPONSE_TYPE_COMPLETED if response.details != null -> {
            ...
            RESPONSE_TYPE_ACTION if response.action is RedirectAction -> {
            ...
            RESPONSE_TYPE_ACTION if response.action is Threeds2Action -> {
