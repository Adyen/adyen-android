...
def _upload_repository_by_key(auth, repo_key, publishing_type_value):
    ...
    # Returns True if successful (2xx or 408), False otherwise.
    if not repo_key:
    ...
    # Success conditions: 2xx status codes or specifically HTTP 408
    if 200 <= response.status_code < 300 or response.status_code == 408:
