...
package com.adyen.checkout.atome.internal.provider
...
constructor(
    ...
    PaymentComponentProvider<
        ...
        AtomeConfiguration,
        AtomeComponentState,
        ComponentCallback<AtomeComponentState>
        >,
    ...
    override fun get(
        ...
        componentCallback: ComponentCallback<AtomeComponentState>,
        order: Order?,
        key: String?
    ): AtomeComponent {
        ...
        val genericFactory = viewModelFactory(savedStateRegistryOwner, null) { savedStateHandle ->
            ...
            AtomeComponent(
                atomeDelegate = atomeDelegate,
                genericActionDelegate = genericActionDelegate,
                actionHandlingComponent = DefaultActionHandlingComponent(genericActionDelegate, atomeDelegate),
                componentEventHandler = DefaultComponentEventHandler(),
            )
        }

        return ViewModelProvider(viewModelStoreOwner, genericFactory)[key, AtomeComponent::class.java]
            .also { component ->
    ...
    override fun isPaymentMethodSupported(paymentMethod: PaymentMethod): Boolean {
        return AtomeComponent.PAYMENT_METHOD_TYPES.contains(paymentMethod.type)
    }
    ...
    override fun get(
        ...
        configuration: AtomeConfiguration,
        application: Application,
        componentCallback: SessionComponentCallback<AtomeComponentState>,
        key: String?
    ): AtomeComponent {
        assertSupported(paymentMethod)
        ...
        val genericFactory = viewModelFactory(savedStateRegistryOwner, null) { savedStateHandle ->
            ...
            val sessionComponentEventHandler =
                SessionComponentEventHandler<AtomeComponentState>(
