...
import com.adyen.checkout.bcmc.internal.ui.model.BcmcComponentParamsMapperNew
...
class BcmcComponentProviderNew
...
constructor(
    ...
    private val componentParamsMapper = BcmcComponentParamsMapperNew(overrideComponentParams, overrideSessionParams)
    ...
    override fun get(
        ...
        return ViewModelProvider(
            viewModelStoreOwner,
            bcmcFactory
        )[key, BcmcComponentNew::class.java].also { component ->
    ...
    override fun isPaymentMethodSupported(paymentMethod: PaymentMethod): Boolean {
        return BcmcComponentNew.PAYMENT_METHOD_TYPES.contains(paymentMethod.type)
    }
}
