...
class DotpayComponentProvider(
...
) : SessionPaymentComponentProvider<DotpayComponent, DotpayConfiguration, PaymentComponentState<DotpayPaymentMethod>> {
    ...
    override fun get(
        ...
        defaultArgs: Bundle?,
        componentCallback: ComponentCallback<PaymentComponentState<DotpayPaymentMethod>>,
        order: Order?,
        key: String?
    ): DotpayComponent {
    ...
    override fun get(
        ...
        application: Application,
        defaultArgs: Bundle?,
        componentCallback: SessionComponentCallback<PaymentComponentState<DotpayPaymentMethod>>,
        key: String?
    ): DotpayComponent {
        assertSupported(paymentMethod)
