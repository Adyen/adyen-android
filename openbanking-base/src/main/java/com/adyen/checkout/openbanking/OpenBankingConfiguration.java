...
public class OpenBankingConfiguration extends IssuerListConfiguration {
     ...
     */
    public OpenBankingConfiguration(@NonNull Locale shopperLocale, @NonNull DisplayMetrics displayMetrics, @NonNull Environment environment) {
    ...
    public static final class Builder extends IssuerListBuilder<OpenBankingConfiguration> {
        ...
        public OpenBankingConfiguration build() {
            return new OpenBankingConfiguration(mBuilderShopperLocale, mBuilderDisplayMetrics, mBuilderEnvironment);
        }
    }
}
