...
class PayToConfiguration(
    ...
    class Builder :
        ...
        override fun buildInternal(): PayToConfiguration {
            return PayToConfiguration(
...
fun CheckoutConfiguration.payTo(
    ...
    val config = PayToConfiguration.Builder(environment, clientKey)
        .apply {
        ...
        .apply(configuration)
        .build()
    addConfiguration(PaymentMethodTypes.PAY_TO, config)
    return this
}

internal fun CheckoutConfiguration.getPayToConfiguration(): PayToConfiguration? {
    return getConfiguration(PaymentMethodTypes.PAY_TO)
}

internal fun PayToConfiguration.toCheckoutConfiguration(): CheckoutConfiguration {
