...
class PayEasyComponentProvider(
...
) : PaymentComponentProvider<PayEasyComponent, PayEasyConfiguration> {
    ...
    override fun get(
        ...
        return ViewModelProvider(viewModelStoreOwner, genericFactory)[key, PayEasyComponent::class.java]
    }
    ...
    override fun isPaymentMethodSupported(paymentMethod: PaymentMethod): Boolean {
        return PayEasyComponent.PAYMENT_METHOD_TYPES.contains(paymentMethod.type)
    }
}
