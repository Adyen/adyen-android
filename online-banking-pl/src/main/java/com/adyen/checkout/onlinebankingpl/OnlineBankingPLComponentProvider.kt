...
class OnlineBankingPLComponentProvider(
    ...
    override fun get(
        ...
        defaultArgs: Bundle?,
        componentCallback: ComponentCallback<PaymentComponentState<OnlineBankingPLPaymentMethod>>,
        order: Order?,
        key: String?
    ): OnlineBankingPLComponent {
    ...
    override fun get(
        ...
        application: Application,
        defaultArgs: Bundle?,
        componentCallback: SessionComponentCallback<PaymentComponentState<OnlineBankingPLPaymentMethod>>,
        key: String?
    ): OnlineBankingPLComponent {
        assertSupported(paymentMethod)
