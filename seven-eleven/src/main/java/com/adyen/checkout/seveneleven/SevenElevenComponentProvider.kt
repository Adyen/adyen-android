...
class SevenElevenComponentProvider(
...
) : PaymentComponentProvider<SevenElevenComponent, SevenElevenConfiguration> {
    ...
    override fun get(
        ...
        return ViewModelProvider(viewModelStoreOwner, genericFactory)[key, SevenElevenComponent::class.java]
    }
    ...
    override fun isPaymentMethodSupported(paymentMethod: PaymentMethod): Boolean {
        return SevenElevenComponent.PAYMENT_METHOD_TYPES.contains(paymentMethod.type)
    }
}
