...
internal class MealVoucherComponentParamsMapperTest {

    private val mealVoucherComponentParamsMapper = MealVoucherComponentParamsMapper(CommonComponentParamsMapper())
    ...
    fun `when drop-in override params are null then params should match the component configuration`() {
        ...
        val params = mealVoucherComponentParamsMapper.mapToParams(configuration, DEVICE_LOCALE, null, null)
    ...
    fun `when drop-in override params are set then they should override component configuration fields`() {
        ...
        val params =
            mealVoucherComponentParamsMapper.mapToParams(configuration, DEVICE_LOCALE, dropInOverrideParams, null)
    ...
    fun `amount should match value set in sessions then drop in then component configuration`(
        ...
        val params = mealVoucherComponentParamsMapper.mapToParams(
    ...
    private fun createCheckoutConfiguration(
        amount: Amount? = null,
        shopperLocale: Locale? = null,
        configuration: MealVoucherConfiguration.Builder.() -> Unit = {}
