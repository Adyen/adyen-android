...
`callPayments(...)` should return `SubmitResult`, and `callDetails(...)` should return `AdditionalDetailsResult`. `renderCheckout(...)` should render `CheckoutPaymentFlow(...)` from your Compose UI layer.
