...
import com.adyen.checkout.googlepay.internal.ui.GooglePayAvailabilityCheck
...
constructor(
    ...
    override fun isAvailable(
        ...
        GooglePayAvailabilityCheck().invoke(
            application,
            componentParams,
            paymentsClient,
        ) { isAvailable ->
            callback.onAvailabilityResult(isAvailable, paymentMethod)
        }
    }
