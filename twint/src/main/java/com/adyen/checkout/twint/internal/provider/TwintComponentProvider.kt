...
constructor(
    ...
    private val componentParamsMapper = TwintComponentParamsMapper(overrideComponentParams, overrideSessionParams)
    ...
    override fun get(
        ...
        val viewModelFactory = viewModelFactory(savedStateRegistryOwner, null) { savedStateHandle ->
            ...
            TwintComponent(
                twintDelegate = twintDelegate,
                genericActionDelegate = genericActionDelegate,
                actionHandlingComponent = DefaultActionHandlingComponent(genericActionDelegate, twintDelegate),
    ...
    override fun get(
        ...
        val viewModelFactory = viewModelFactory(savedStateRegistryOwner, null) { savedStateHandle ->
            ...
            val sessionComponentEventHandler = SessionComponentEventHandler<TwintComponentState>(
