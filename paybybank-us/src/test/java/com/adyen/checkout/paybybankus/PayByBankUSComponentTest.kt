...
internal class PayByBankUSComponentTest(
    @param:Mock private val payByBankUSDelegate: PayByBankUSDelegate,
    ...
    @param:Mock private val componentEventHandler: ComponentEventHandler<PayByBankUSComponentState>,
) {
