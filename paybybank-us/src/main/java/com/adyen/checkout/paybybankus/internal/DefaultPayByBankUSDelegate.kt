...
internal class DefaultPayByBankUSDelegate(
    ...
    private val inputData: PayByBankUSInputData = PayByBankUSInputData()

    override val outputDataFlow: Flow<PayByBankUSOutputData>
    ...
    override fun updateInputData(update: PayByBankUSInputData.() -> Unit) {
        TODO("Not yet implemented")
    }
